#!/usr/bin/env python3
"""Experiment C benchmark: N=100, c=8, ISL~2048, OSL=256. Uses stdlib only."""
import json
import statistics
import sys
import threading
...
print(f"Starting benchmark: N={N} c={C} ISL~2016 OSL=256", flush=True)
...
n = len(lats)
out = {
    "experiment": "Exp C baseline – single A100-PCIE-80GB, Qwen/Qwen3-8B BF16, vLLM 0.19.0",
    ...
    "note": "Non-disaggregated baseline. Disagg blocked by binary/image issues documented in PR.",
}
