...
> **Deploy:** this variant is one CSP of the Helm chart in the parent directory. After creating the model cache, render and apply it with `helm template q32b .. --set csp=<csp> | kubectl apply -f -` (run from the parent dir); see the [family Deploy section](../README.md#deploy).
