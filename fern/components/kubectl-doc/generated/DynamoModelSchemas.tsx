...
const kubectlDocSchemas = [
  {
    ...
    "lines": [
      ...
      {
        "index": 89,
        "text": "# DynamoModelSpec defines the desired state of DynamoModel",
      ...
      {
        "index": 91,
        "text": "  # BaseModelName is the base model identifier that matches the service label",
      ...
      {
        "index": 92,
        "text": "  # This is used to discover endpoints via headless services",
        "description": "This is used to discover endpoints via headless services",
        "depth": 1,
        "path": "spec.baseModelName",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-spec-basemodelname"
      ...
      {
        "index": 95,
        "text": "  # ModelName is the full model identifier (e.g.,",
        "description": "ModelName is the full model identifier (e.g.,",
        "depth": 1,
        "path": "spec.modelName",
        "required": true,
      ...
      {
        "index": 96,
        "text": "  # \"meta-llama/Llama-3.3-70B-Instruct-lora\")",
        "description": "\"meta-llama/Llama-3.3-70B-Instruct-lora\")",
        "depth": 1,
        "path": "spec.modelName",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-spec-modelname"
      ...
      {
        "index": 99,
        "text": "  # ModelType specifies the type of model (e.g., \"base\", \"lora\", \"adapter\")",
      ...
      {
        "index": 100,
        "text": "  # modelType: \"base\" # default, enum: \"lora\" | \"adapter\"",
        "description": "ModelType specifies the type of model (e.g., \"base\", \"lora\", \"adapter\")",
        "depth": 1,
        "field": "modelType",
        "path": "spec.modelType",
      ...
      {
        "index": 102,
        "text": "  # Source specifies the model source location (only applicable for lora model",
        "description": "Source specifies the model source location (only applicable for lora model",
        "depth": 1,
        "path": "spec.source",
      ...
      {
        "index": 105,
        "text": "    # URI is the model source URI Supported formats: - S3:",
        "description": "URI is the model source URI Supported formats: - S3:",
        "depth": 2,
      ...
      {
        "index": 106,
        "text": "    # s3://bucket/path/to/model - HuggingFace: hf://org/model@revision_sha",
        "description": "s3://bucket/path/to/model - HuggingFace: hf://org/model@revision_sha",
        "depth": 2,
        "path": "spec.source.uri",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-spec-source-uri"
      ...
      {
        "index": 109,
        "text": "# DynamoModelStatus defines the observed state of DynamoModel",
      ...
      {
        "index": 111,
        "text": "  # ReadyEndpoints is the count of endpoints that are ready",
      ...
      {
        "index": 114,
        "text": "  # TotalEndpoints is the total count of endpoints",
      ...
      {
        "index": 117,
        "text": "  # Conditions represents the latest available observations of the model's state",
      ...
      {
        "index": 149,
        "text": "  # Endpoints is the current list of all endpoints for this model",
      ...
      {
        "index": 151,
        "text": "    - # Address is the full address of the endpoint (e.g.,",
        "description": "Address is the full address of the endpoint (e.g.,",
        "depth": 3,
      ...
      {
        "index": 152,
        "text": "      # \"http://10.0.1.5:9090\")",
        "description": "\"http://10.0.1.5:9090\")",
        "depth": 3,
        "path": "status.endpoints[].address",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-status-endpoints-address"
      ...
      {
        "index": 155,
        "text": "      # Ready indicates whether the endpoint is ready to serve traffic For LoRA",
        "description": "Ready indicates whether the endpoint is ready to serve traffic For LoRA",
        "depth": 3,
      ...
      {
        "index": 156,
        "text": "      # models: true if the POST /loras request succeeded with a 2xx status code",
        "description": "models: true if the POST /loras request succeeded with a 2xx status code",
        "depth": 3,
        "path": "status.endpoints[].ready",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-status-endpoints-ready"
      ...
      {
        "index": 157,
        "text": "      # For base models: always false (no probing performed)",
        "description": "For base models: always false (no probing performed)",
        "depth": 3,
        "path": "status.endpoints[].ready",
        "required": true,
        "detailId": "field-nvidia-com-v1alpha1-status-endpoints-ready"
      ...
      {
        "index": 160,
        "text": "      # PodName is the name of the pod serving this endpoint",
    ...
    "fields": [
      ...
      },
      {
        ...
        "description": "DynamoModelSpec defines the desired state of DynamoModel",
        "metadata": [
          "requiredFields: baseModelName, modelName"
        ]
      },
      {
        "id": "field-nvidia-com-v1alpha1-spec-basemodelname",
        "path": "spec.baseModelName",
        "type": "string",
        "required": true,
        "description": "BaseModelName is the base model identifier that matches the service label\nThis is used to discover endpoints via headless services"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-spec-modelname",
        "path": "spec.modelName",
        "type": "string",
        "required": true,
        "description": "ModelName is the full model identifier (e.g., \"meta-llama/Llama-3.3-70B-Instruct-lora\")"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-spec-modeltype",
        "path": "spec.modelType",
        "type": "string",
        "required": false,
        "description": "ModelType specifies the type of model (e.g., \"base\", \"lora\", \"adapter\")",
      ...
      {
        "id": "field-nvidia-com-v1alpha1-spec-source",
        "path": "spec.source",
        "type": "object",
        "required": false,
        "description": "Source specifies the model source location (only applicable for lora model type)",
      ...
      {
        "id": "field-nvidia-com-v1alpha1-spec-source-uri",
        "path": "spec.source.uri",
        "type": "string",
        "required": true,
        "description": "URI is the model source URI\nSupported formats:\n- S3: s3://bucket/path/to/model\n- HuggingFace: hf://org/model@revision_sha"
      },
      {
        ...
        "description": "DynamoModelStatus defines the observed state of DynamoModel",
        "metadata": [
          "requiredFields: readyEndpoints, totalEndpoints"
        ]
      },
      {
      ...
      {
        "id": "field-nvidia-com-v1alpha1-status-endpoints-address",
        "path": "status.endpoints[].address",
        "type": "string",
        "required": true,
        "description": "Address is the full address of the endpoint (e.g., \"http://10.0.1.5:9090\")"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-status-endpoints-podname",
        "path": "status.endpoints[].podName",
        "type": "string",
        "required": false,
        "description": "PodName is the name of the pod serving this endpoint"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-status-endpoints-ready",
        "path": "status.endpoints[].ready",
        "type": "boolean",
        "required": true,
        "description": "Ready indicates whether the endpoint is ready to serve traffic\nFor LoRA models: true if the POST /loras request succeeded with a 2xx status code\nFor base models: always false (no probing performed)"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-status-readyendpoints",
        "path": "status.readyEndpoints",
        "type": "integer",
        "required": true,
        "description": "ReadyEndpoints is the count of endpoints that are ready"
      ...
      {
        "id": "field-nvidia-com-v1alpha1-status-totalendpoints",
        "path": "status.totalEndpoints",
        "type": "integer",
        "required": true,
        "description": "TotalEndpoints is the total count of endpoints"
...
export function DynamoModelSchema0() {
